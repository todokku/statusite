...
from .models import Repository, Release, BuildResult
...
class TestBuildReleaseWebhook(TestCase):
    ...
    def test_build_release_webhook(self):
        ...
        response = self.client.post('/repo/webhook/mbci/build', json.dumps(build_event), content_type="application/json")
